import 'package:digitaldungeons/blocs/character/character-list/character-list_bloc.dart';
...
class DDCharactersListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<DDCharacterListBloc>(
      create: (providerContext) => DDCharacterListBloc(),
      child: SafeArea(
        child: Scaffold(
