import 'package:digitaldungeons/blocs/sign-up/sign-up_events.dart';
import 'package:digitaldungeons/blocs/sign-up/sign-up_state.dart';
...
class DDSignUpBloc extends Bloc<DDSignUpEvent, DDSignUpState> {
  ...
  Stream<DDSignUpState> mapEventToState(DDSignUpEvent event) async* {
    if (event is DDSignUpSubmitEvent) {
      // send request if valid, else pop-up
      yield state;
    }
